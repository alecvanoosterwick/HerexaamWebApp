...
namespace WebShop.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new WebShopUser { UserName = Input.Email, Email = Input.Email, FirstName = Input.VoorNaam, LastName = Input.AchterNaam, Adress = Input.Adres, PostalCode = Input.PostCode, Country = Input.Land };
